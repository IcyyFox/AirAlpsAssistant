...
fuelcost = 0.61
# Passengerperkm is how much passengers are required to pay per KM
passengerPerKm = 0.210
# Efficiency is kg of fuel burned per km
efficiency = 0
print("    ___    _         ___    __          ")
time.sleep(0.05)
...
if flight == "AAP0015":
    departure = "Zurich/ZRH"
    arrival = "Salzburg/SZG"
    distance = 337
    EFD = 50
if flight == "AAP0016":
    departure = "Salzburg/SZG"
    arrival = "Zurich/ZRH"
    distance = 337
    EFD = 50
if codeshare == "None":
...
if distance == 0:
    ...
    time.sleep(0.08)
    print("Shiba&Co ATR 72-600: Type 726")
    ...
    if aircraftType == "726":
        if codeshare == "None":
            print("The ATR 72-600 is only Available for certain Codeshare flights such as AAP4003 & 4004.\nSee https://discord.com/channels/1093758393505828955/1093786168463720498 for more information.")
        efficiency = 0.026
        capacity = 72
        aircraft = "Shiba&Co ATR 72-600"
    fuelburn = efficiency * distance
    ticketcost = passengerPerKm * distance
    fueltotalcost = fuelcost * distance
    ...
    print("> Notes: " + note)
    print("> Codeshare: " + codeshare)
    print("-----")
    print("> Estimated Fuel Burned: " + str(fuelburn))
    print("> Estimated Cost of Fuel: " + str(fueltotalcost))
    print("> Ticket Cost: " + str(ticketcost))
    print("--------" + flight + "--------")
    print("||Most of this information is not mandatory, please read #Rules for the required information||")
    print()
